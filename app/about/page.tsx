...
export default function AboutPage() {
  return (
    <div className="container py-12">
      ...
      {/* Mission Section */}
      <section id="mission" className="mb-16 scroll-mt-16">
      ...
      <section id="experts" className="scroll-mt-16">
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-3">
          {experts.map((expert) => (
            <div key={expert.name} className="rounded-lg border p-6">
              <div className="relative mb-4 h-[200px] overflow-hidden rounded-lg">
                <Image
                  src={expert.image}
                  alt={expert.name}
                  fill
