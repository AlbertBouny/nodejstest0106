    ...
    <div className="container relative pb-10">
      ...
      <section className="container space-y-6 py-8 md:py-12">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <Link href="/arts/purple-star" className="group relative rounded-lg border p-6 hover:border-primary">
            <h3 className="font-heading text-2xl">Purple Star Astrology</h3>
            <p className="text-muted-foreground">
              Explore Zi Wei Dou Shu, the imperial system of Chinese astrology.
            </p>
          </Link>

          <Link href="/arts/four-pillars" className="group relative rounded-lg border p-6 hover:border-primary">
            <h3 className="font-heading text-2xl">Four Pillars of Destiny</h3>
            <p className="text-muted-foreground">
              Understand BaZi, the art of destiny analysis through time cycles.
            </p>
          </Link>

          <Link href="/arts/relationships" className="group relative rounded-lg border p-6 hover:border-primary">
          ...
          <Link href="/arts/marriage" className="group relative rounded-lg border p-6 hover:border-primary">
          ...
          <Link href="/arts/names" className="group relative rounded-lg border p-6 hover:border-primary">
            <h3 className="font-heading text-2xl">Astrological Names</h3>
            <p className="text-muted-foreground">
              Learn about selecting names based on astrological principles.
            </p>
          </Link>

          <Link href="/arts/feng-shui" className="group relative rounded-lg border p-6 hover:border-primary">
          ...
          <Link href="/arts/dreams" className="group relative rounded-lg border p-6 hover:border-primary">
